...
const GENERATED_FAMILIES: GeneratedFamily[] = [
  ...
  },
  {
    ...
    prompt: (variant) => `Return a run-length encoded string for variant ${variant}, where each group is the character followed by the group count.`,
    ratingBase: 1540,
  ...
  },
  {
    ...
    prompt: (variant) => `Return the largest adjacent sorted gap for variant ${variant} after sorting nums ascending.`,
    ratingBase: 1940,
  ...
  },
  {
    ...
    prompt: (variant) => `Return the number of islands of 1s in grid variant ${variant} using four-directional adjacency.`,
    ratingBase: 2120,
  ...
  },
  {
    ...
    prompt: (variant) => `Return the length of the longest strictly increasing subsequence for sequence variant ${variant}.`,
    ratingBase: 2380,
  ...
  },
  {
    ...
    prompt: (variant) => `Return the cheapest path cost from start to target in directed weighted graph variant ${variant}.`,
    ratingBase: 2620,
  ...
  },
  {
    ...
    prompt: (variant) => `Return the minimum edit distance between wordA and wordB for word-pair variant ${variant}.`,
    ratingBase: 2780,
  ...
  },
  {
    ...
    prompt: (variant) => `Split nums into at most k contiguous groups for variant ${variant} and return the minimized largest group sum.`,
    ratingBase: 3100,
  ...
  },
  {
    ...
    prompt: (variant) => `Return true if nums variant ${variant} can be partitioned into two groups with equal sum.`,
    ratingBase: 3300,
