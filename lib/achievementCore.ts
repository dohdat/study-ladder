...
export const ACHIEVEMENT_DEFINITIONS: AchievementDefinition[] = [
  ...
  { badge: "100", colors: ["#2f2413", "#c49a4a", "#ffe7ae"], description: "Solve 100 different LeetCode rooms.", id: "completed-grimoire", metric: "solved", target: 100, title: "Hundred Page Grimoire" },
  { badge: "S7", colors: ["#4b1d2a", "#fb7185", "#ffe4e6"], description: "Clear 7 combat questions in a row without breaking your streak.", id: "perfect-memory", metric: "streak", target: 7, title: "Flawless Chain" },
