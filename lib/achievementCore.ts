...
export const ACHIEVEMENT_DEFINITIONS: AchievementDefinition[] = [
  ...
  { badge: "FM", colors: ["#273143", "#7aa2f7", "#d8e5ff"], description: "Master one question through review.", id: "first-mastery", metric: "mastered", target: 1, title: "First Mastery" },
  { badge: "TB", colors: ["#2c3340", "#8aa1c1", "#edf4ff"], description: "Master 3 questions.", id: "tome-binder", metric: "mastered", target: 3, title: "Tome Binder" },
  { badge: "AM", colors: ["#34234e", "#9d6bff", "#eadcff"], description: "Master 6 questions.", id: "archmage-memory", metric: "mastered", target: 6, title: "Archmage Memory" },
  { badge: "PM", colors: ["#4b3b14", "#f6d365", "#fff7ca"], description: "Master every current question.", id: "perfect-memory", metric: "mastered", target: questions.length, title: "Perfect Memory" },
