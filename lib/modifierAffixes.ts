...
export const MODIFIER_ARCHETYPES: Array<{ id: string; label: string; keys: ItemModifierKey[] }> = [
  ...
  { id: "elemental-fire", label: "Fire piercing", keys: ["fireDamage", "resistancePenetrationPercent", "enhancedDamagePercent", "fireResistPercent"] },
  { id: "elemental-cold", label: "Cold piercing", keys: ["coldDamage", "resistancePenetrationPercent", "criticalChancePercent", "coldResistPercent"] },
  { id: "elemental-lightning", label: "Lightning piercing", keys: ["lightningDamage", "resistancePenetrationPercent", "extraAttackChancePercent", "lightningResistPercent"] },
  { id: "elemental-poison", label: "Poison piercing", keys: ["poisonDamage", "resistancePenetrationPercent", "executeChancePercent", "poisonResistPercent"] },
