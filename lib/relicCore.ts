...
const ROGUELIKE_RELIC_SOURCE_DETAILS: Record<string, { description: string; wikiStats: string[] }> = {
  ...
  "Smoke Step": { description: "a simple dodge boost for risky routes.", wikiStats: ["Trigger: onIncomingDamage.", "Tuning: small dodge chance."] },
  ...
  "Campfire Tools": { description: "rest sites offer one extra action instead of a single fixed reward.", wikiStats: ["Trigger: restEnter.", "Tuning: choose heal, smith, or attune a relic."] },
...
const COMMON_RELICS: Relic[] = [
  ...
  relic("Smoke Step", "common", "A simple dodge boost for risky routes.", { dodgeChancePercent: 5 }),
